...
export const getAllUsers = createAsyncThunk("getAllUsers", async () => {
  try {
    const res = await axios.get(
      `https://awadouf.e3lanotopia.software/api/th/get_all_users`
    );
    return res.data;
  } catch (err) {
    return err.message;
...
export const getAllCourses = createAsyncThunk("getAllCources", async () => {
  try {
    const res = await axios.get(
      `https://awadouf.e3lanotopia.software/api/th/get_all_courses`
    );
    return res.data;
  } catch (err) {
    return err.message;
...
export const getOneUser = createAsyncThunk("searchOneUser", async (args) => {
  try {
    const res = await axios.get(
      `https://awadouf.e3lanotopia.software/api/th/get_user_data/${args.email}`
    );
    return res.data;
  } catch (err) {
    return err.message;
...
export const getUserCourses = createAsyncThunk("userCourses", async (args) => {
  try {
    const res = await axios.get(
      `https://awadouf.e3lanotopia.software/api/th/get_user_courses/${args}`
    );
    return res.data;
  } catch (err) {
    return err.message;
...
export const deleteUser = createAsyncThunk("deleteUser", async (args) => {
  try {
    const res = await axios.get(
      `https://awadouf.e3lanotopia.software/api/th/delete_user/${args}`
    );
    return res.data;
  } catch (err) {
    return err.message;
...
export const editUser = createAsyncThunk("editUser", async (args) => {
  try {
    const res = await axios.post(
      `https://awadouf.e3lanotopia.software/api/th/edit_user/${args.id}`,
      args.data
    );
    return res.data;
  } catch (err) {
